# [full stack apache2 Phalcon for everyone with docker compose](https://github.com/damalis/full-stack-apache2-phalcon-for-everyone-with-docker-compose)

If You want to build a website with Phalcon at short time; 

#### Full stack Apache2 Phalcon:
...
- [Phalcon](https://github.com/phalcon) - [php-fpm](https://hub.docker.com/_/php?tab=tags&page=1&name=fpm)
...
```
git clone https://github.com/damalis/full-stack-apache2-phalcon-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-apache2-phalcon-for-everyone-with-docker-compose
chmod +x install.sh
./install.sh
```
